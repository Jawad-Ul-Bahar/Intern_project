...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <div class="container-fluid">
            ...
            <!-- Area and pie chart row -->
            <div class="row">

                <!-- Area chart for earnings overview -->
            ...
            <!-- Second row with projects and illustrations -->
            <div class="row">

                <!-- Left column with progress cards and color system -->
...
<!-- Scripts required by the template -->
