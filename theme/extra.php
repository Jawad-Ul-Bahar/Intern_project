	...
	<div class="bg0 m-t-23 p-b-140">
		<div class="container">
			...
			<div class="row isotope-grid">
				...
				if(isset($_GET['id'])){
					$cid= $_GET['id'];
					$pro=mysqli_query($con,"SELECT * FROM `products` WHERE cat_id=$cid'");
				...
				<div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item women">
					...
					<div class="block2">
						<div class="block2-pic hov-img0">
							<img src="../adminpanel/img/<?php echo $p[5]?>" alt="IMG-PRODUCT">
						...
						<div class="block2-txt flex-w flex-t p-t-14">
							<div class="block2-txt-child1 flex-col-l ">
								<a href="product-detail.php?proid=<?php echo $p[0] ?>" class="stext-104 cl4 hov-cl1 trans-04 js-name-b2 p-b-6">
								<?php echo $p[1]?>
								</a>
...
if(isset($_GET['proid'])){
	$pid=$_GET['proid'];
	$pro=mysqli_query($con,"SELECT * FROM `product` where id=$pid");
						...
						<div class="wrap-slick3 flex-sb flex-w">
							...
							<div class="wrap-slick3-arrows flex-sb-m flex-w"></div>
								...
								<div class="item-slick3" data-thumb="images/product-detail-03.jpg">
									<div class="wrap-pic-w pos-relative">
										<img src="../adminpanel3/img/<?php echo $pro[5]?>" alt="IMG-PRODUCT">
...
<?php
session_start();
// session_destroy(); // Uncomment if needed to reset session during testing
?>
            ...
            <nav class="limiter-menu-desktop container">
                ...
                <div class="wrap-icon-header flex-w flex-r-m">
                    ...
                    <div class="icon-header-item cl2 hov-cl1 trans-04 p-l-22 p-r-11 icon-header-noti js-show-cart" data-notify="<?php
                        ...
                        echo $count;  // Output the number of items in cart
                    ?>">
    ...
    <div class="wrap-header-mobile">
        ...
        <div class="wrap-icon-header flex-w flex-r-m m-r-15">
            ...
            <div class="icon-header-item cl2 hov-cl1 trans-04 p-r-11 p-l-10 icon-header-noti js-show-cart" data-notify="<?php
                echo isset($_SESSION['cart']) ? count($_SESSION['cart']) : '0';  // Output the number of items in cart
            ?>">
                <i class="zmdi zmdi-shopping-cart"></i>
            </div>
        ...
        <div class="header-cart-content flex-w js-pscroll">
            ...
            <div class="w-full">
                <div class="header-cart-total w-full p-tb-40">
                    Total: RS <?php echo number_format($count, 2); ?>
                </div>
